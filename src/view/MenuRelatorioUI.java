 ...
 * 
 */
public class MenuRelatorioUI {
    /*    
    Opcao verClientes = new Opcao("Relatorio de clientes");
        Opcao verAvioes = new Opcao("Relatorio de avioes");
        Opcao verVendas = new Opcao("Relatorio de vendas");
        ...
        //construtor
        public MenuRelatorioUI(RepositorioVendas listaVendas, RepositorioClientes listaClientes,RepositorioAvioes listaAvioes, RepositorioVoos listaVoos) {
